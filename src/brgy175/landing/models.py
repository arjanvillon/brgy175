...
class IDForm(models.Model):
    resident_idform = models.ForeignKey(Resident, on_delete=models.CASCADE)
...
class IndigencyForm(models.Model):
    resident_indigency = models.ForeignKey(Resident, on_delete=models.CASCADE)
...
class ClearanceForm(models.Model):
    resident_clearance = models.ForeignKey(Resident, on_delete=models.CASCADE)
...
class BusinessPermit(models.Model):
    resident_business = models.ForeignKey(Resident, on_delete=models.CASCADE)
...
class ScholarshipForm(models.Model):
    resident_scholarship = models.ForeignKey(Resident, on_delete=models.CASCADE)
...
class BurialForm(models.Model):
    resident_burial = models.ForeignKey(Resident, on_delete=models.CASCADE)
